                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="text-start" style="width: 45%;">
                                        <div id="personalinfo" v-for="(getinfo, index) in PersonalArray" :key="index" class="text-center">
                                            <h2 class="fw-semibold text-dark text-center mb-1">{{ getinfo.Fullname }}</h2>
                                            <p class="fw-normal text-dark text-center">{{ getinfo.Career }}</p>
                                            <img v-if="getinfo.profile" class="text-center border border-dark py-2 px-2" :src="getinfo.profile" alt="" width="170" height="160">
                                            <img v-else class="text-center border border-dark py-2 px-2" src="./assets/profile.png" alt="" width="170" height="160">
                                            <br><br>
                                            <p class="fw-normal text-dark" style="font-size: 12px; text-align: justify;">{{ getinfo.Summary }}</p>
                                            <div class="mt-4 text-start">
                                                <div class="py-2 px-2 border-black border-top border-bottom">
                                                    <span class="text-dark fw-semibold"><i class="bi bi-person-lines-fill"></i> CONTACT</span>
                                                </div>
                                                <div class="d-flex justify-content-between py-2 px-2 border-black border-bottom">
                                                    <div class="text-center border-black border-end" style="width: 20%;">
                                                        <i class="bi bi-house-fill text-dark"></i>
                                                    </div>
                                                    <div class="text-end ps-1" style="width: 80%;">
                                                        <p class="fw-normal text-secondary mb-0" style="font-size: 12px;">{{ getinfo.Location }}</p>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-between py-2 px-2 border-black border-bottom">
                                                    <div class="text-center border-black border-end" style="width: 20%;">
                                                    ...
                                                    <div class="text-end ps-1" style="width: 80%;">
                                                        <p class="fw-normal text-secondary mb-0" style="font-size: 12px;">{{ getinfo.Phone }}</p>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-between py-2 px-2 border-black border-bottom">
                                                    <div class="text-center border-black border-end" style="width: 20%;">
                                                    ...
                                                    <div class="text-end ps-1" style="width: 80%;">
                                                        <p class="fw-normal text-secondary mb-0" style="font-size: 12px;">{{ getinfo.Email }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="skill" class="mt-5 text-start">
                                            <div class="py-2 px-2 border-black border-top border-bottom">
                                                <span class="text-dark fw-semibold"><i class="bi bi-gear-wide-connected"></i> SKILLS</span>
                                            </div>
                                            <div v-for="(pair, index) in skillPairs" :key="index" class="d-flex justify-content-between">
                                                <div class="text-start mt-2" v-for="(getskill, idx) in pair" :key="idx">
                                                    <p class="fw-normal text-dark mb-0" style="font-size: 12px;">{{ getskill.Skill }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="award" class="mt-5">
                                            ...
                                            <div v-for="(getaward, index) in AwardArray" :key="index" class="">
                                                <ul class="mt-3">
                                                    <li>
                                                        <h5 class="fw-semibold text-dark mb-0" style="font-size: 15px;">{{ getaward.Details }}</h5>
                                                        <p class="fw-normal text-secondary mb-0" style="font-size: 12px;">Date: {{ getaward.Date }}</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-start" style="width: 50%;">
                                        <div id="education">
                                            <div class="py-2 px-2 border-black border-top border-bottom">
                                                <span class="text-dark fw-semibold"><i class="bi bi-mortarboard-fill"></i> EDUCATION</span>
                                            </div>
                                            <div v-for="(getedu, index) in EducationArray" :key="index" class="">
                                                <ul class="mt-3">
                                                    <li>
                                                        <h5 class="fw-semibold text-dark mb-0" style="font-size: 16px;">{{ getedu.University }}</h5>
                                                        <ul>
                                                            <li> <p class="fw-normal text-dark mb-0" style="font-size: 12px;">{{ getedu.Program }}</p> </li>
                                                            <li> <p class="fw-normal text-dark mb-0" style="font-size: 12px;">From: {{ getedu.StartDate }}</p> </li>
                                                            <li> <p class="fw-normal text-dark mb-0" style="font-size: 12px;">To: {{ getedu.EndDate }}</p> </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div id="experience">
                                            <div class="py-2 px-2 border-black border-top border-bottom">
                                                <span class="text-dark fw-semibold"><i class="bi bi-briefcase-fill"></i> EXPERIENCE</span>
                                            </div>
                                            <div v-for="(getexp, index) in ExperienceArray" :key="index" class="">
                                                <ul class="mt-3">
                                                    <li>
                                                        <h5 class="fw-semibold text-dark mb-0" style="font-size: 15px;">{{ getexp.Position }}</h5>
                                                        <p class="fw-normal text-secondary mb-0" style="font-size: 12px;">{{ getexp.Company }}, {{ getexp.StartDate }} - {{ getexp.EndDate }}</p>
                                                        <ul>
                                                           <li> <p class="fw-normal text-dark mb-0" style="font-size: 12px; text-align: justify;">{{ getexp.Description }}</p></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div id="certificate">
                                            ...
                                            <div v-for="(getcert, index) in CertificateArray" :key="index" class="">
                                                <ul class="mt-3">
                                                    <li>
                                                        <h5 class="fw-semibold text-dark mb-0" style="font-size: 15px;">{{ getcert.Details }}</h5>
                                                        <p class="fw-normal text-secondary mb-0" style="font-size: 12px;">Date: {{ getcert.Date }}</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
export default {
    ...
    data(){
        return{
            PersonalArray: [
                {profile: '', Fullname: 'Guy Hawkins', Email: 'GuyHawkins@gmail.com', Career: 'Web Developer', Phone: '(000)954-987-**** ', Location: '134 Rightward Way', Summary: 'Resourceful Full-Stack Web Developer with experience in building responsive, user-focused applications using Laravel, Vue.js, Bootstrap, and Tailwind CSS. Skilled in both front-end and back-end development, with a strong focus on clean code, usability, and modern web standards.'}
            ],
            EducationArray: [
            ...
            CertificateArray: [
                ...
                {Details: 'CAPM - Project Management Institute', Date: '2025-06-10'},
                {Details: 'PRINCE@ Foundation', Date: '2025-06-10'}
            ],
            AwardArray: [
