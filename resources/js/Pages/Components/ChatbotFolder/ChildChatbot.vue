            ...
            <main class="col-12">
                <section id="section1">
                    <div class="row justify-content-end">
                        <div class="col-12">
                            <div class="text-end position-fixed" style="bottom: 2%; right: 2%;">
                                <div v-if="ShowChatbox"  id="chatbox" class="rounded-3 d-flex flex-column justify-content-between bg-white shadow-lg" style="width: 350px; height: 400px;">
                                    <div class="d-flex py-2 px-2 justify-content-between shadow-md border-bottom border-secondary">
                                        <div class="text-start mt-1">
                                            <img width="25" height="25" src="https://img.icons8.com/3d-fluency/94/robot-emoji.png" alt="robot-emoji" class=""/>
                                            <span style="font-size: 13px;" class="text-dark"> AI Support</span>
                                        </div>
                                        <div class="text-start">
                                            <i @click="btnShow" style="cursor: pointer;" class="bi bi-x fs-4 text-dark"></i>
                                        </div>
                                    </div>
                                    <div ref="messageContainer" v-if="MessageProps.length > 0" style="height: 280px; overflow-y: auto; scrollbar-width: none;" class="mt-2">
                                        <div v-for="(getmessage, index) in MessageProps" :key="index" >
                                            ...
                                            <div v-if="getmessage.role == 'chatbot' " class="d-flex justify-content-start">
                                                ...
                                                <p class="fw-light py-2 px-2 ms-2 d-inline-block rounded-4 text-start text-white bg-primary" style="font-size: 12px; max-width: 65%;" v-html="getmessage.content.replace(/[#>*_`]/g, '').replace(/-{3,}/g, '').replace(/(\r\n|\n|\r)/g, '<br>')"></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div v-else class="text-center px-5">
                                        <img width="40" height="40" src="https://img.icons8.com/3d-fluency/94/robot-emoji.png" alt="robot-emoji" class=""/>
                                ...
                                <button v-else  @click="btnShow" class="btn btn-primary rounded-5"> <img width="25" height="25" src="https://img.icons8.com/3d-fluency/94/robot-emoji.png" alt="robot-emoji" class=""/> <span class="d-md-inline d-none" style="font-size: 13px;">AI Support</span></button>
                            </div>
                        </div>
                    </div>
                </section>
